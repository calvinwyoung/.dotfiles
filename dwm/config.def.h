...
static const char *wicdclient[]  = { "xterm", "-e", "wicd-curses", NULL };
static const char *raisevolume[]  = { "amixer", "-q", "set", "PCM", "5%+", "unmute", NULL };
static const char *lowervolume[]  = { "amixer", "-q", "set", "PCM", "5%-", "unmute", NULL };
